...
export const ProductCard: React.FC<{ product: any }> = ({ product }) => {
    return (
        <Link href={`/orders/${product.handle}`}>
            <a tw='h-32 max-w-[20%] bg-no-repeat bg-cover bg-center flex flex-col border-solid border-2 border-white/30 bg-white/25 shadow-sm backdrop-blur-sm rounded-3xl overflow-hidden cursor-pointer'>
                <div
                ...
                <div tw='px-3 py-1'>
                    <h2 tw='font-bold tracking-wide text-[#062821] text-[13px] leading-3'>
