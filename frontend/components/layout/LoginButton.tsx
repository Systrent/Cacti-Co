        ...
        <div tw='flex'>
            ...
            {user && (
                <div tw='inline-flex flex-row gap-1 items-center'>
                    <Link href='/profile'>
                        <a tw='flex items-center bg-[#4BC190] whitespace-nowrap text-white text-base font-semibold tracking-wide rounded-lg ease-in-out duration-300 py-1 px-6 cursor-pointer'>
                            {user.nickname}
                        </a>
                    </Link>
                    <button
